...
public class ModBlocks {
    ...
    // Are you wondering why the Material for the invisible red and white blocks is REPLACEABLE_PLANT instead of AIR?
    ...
    // REPLACEABLE_PLANT breaks when pushed by pistons and has the same replacable properties as AIR.
    // is it a good solution? No.
    // Does it work? Yes.
    // Am I happy about it? No.
    // Could I fix it? Not without significantly more work for the same result.
    ...
    public static final TempWebBlock TEMP_WEB_BLOCK = new TempWebBlock(FabricBlockSettings.of(Material.COBWEB).noCollision().strength(2.0F).ticksRandomly().nonOpaque());
