...
public class ModBlocks {
    ...
    public static void registerBlocks() {
        Registry.register(Registries.BLOCK, new Identifier(Magick.MOD_ID, "light_orb"), LIGHT_ORB);
        Registry.register(Registries.BLOCK, new Identifier(Magick.MOD_ID, "temp_web_block"), TEMP_WEB_BLOCK);
        Registry.register(Registries.BLOCK, new Identifier(Magick.MOD_ID, "red_block"), RED_BLOCK);
        Registry.register(Registries.BLOCK, new Identifier(Magick.MOD_ID, "white_block"), WHITE_BLOCK);
        Registry.register(Registries.BLOCK, new Identifier(Magick.MOD_ID, "red_white_block"), RED_WHITE_BLOCK);
        Registry.register(Registries.BLOCK, new Identifier(Magick.MOD_ID, "warping_block"), WARPING_BLOCK);
    }
}
