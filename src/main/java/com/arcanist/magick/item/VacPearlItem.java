...
import com.arcanist.magick.entity.VacPearlEntity;
...
public class VacPearlItem extends Item {
    public VacPearlItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ...
            world.spawnEntity(vacPearlEntity ); // spawns entity
        }
